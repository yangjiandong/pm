...
@ContextConfiguration(locations = { "/applicationContext-sys-test.xml" })
public class UserDaoTest extends SpringTxTestCase {
    ...
    public void setUp() throws Exception {
        ...
        executeSqlScript("classpath:/sys-schema.sql", false);

        DbUnitUtils.loadData((DataSource) applicationContext.getBean("dataSource"), "classpath:/test-sys-data.xml");
